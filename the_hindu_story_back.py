...
async def main():
    await asyncio.gather(
        id_links(sp - 1 * 1000, sp),
        id_links(sp - 2 * 1000, sp - 1 * 1000),
        id_links(sp - 3 * 1000, sp - 2 * 1000),
        id_links(sp - 4 * 1000, sp - 3 * 1000),
        id_links(sp - 5 * 1000, sp - 4 * 1000),
        id_links(sp - 6 * 1000, sp - 5 * 1000),
        id_links(sp - 7 * 1000, sp - 6 * 1000),
        id_links(sp - 8 * 1000, sp - 7 * 1000),
        id_links(sp - 9 * 1000, sp - 8 * 1000),
        id_links(sp - 10 * 1000, sp - 9 * 1000),
        id_links(sp - 11 * 1000, sp - 10 * 1000),
        id_links(sp - 12 * 1000, sp - 11 * 1000),
        id_links(sp - 13 * 1000, sp - 12 * 1000),
        id_links(sp - 14 * 1000, sp - 13 * 1000),
        id_links(sp - 15 * 1000, sp - 14 * 1000),
        id_links(sp - 16 * 1000, sp - 15 * 1000),
        id_links(sp - 17 * 1000, sp - 16 * 1000),
        id_links(sp - 18 * 1000, sp - 17 * 1000),
        id_links(sp - 19 * 1000, sp - 18 * 1000),
        id_links(sp - 20 * 1000, sp - 19 * 1000),
